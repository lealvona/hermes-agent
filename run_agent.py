...
class AIAgent:
    ...
    def _build_system_prompt(self, system_message: str = None) -> str:
        ...
        # Always-on "how to help the user with Hermes itself" pointer — docs
        # URL + the hermes-agent skill. Not tool-gated: if skill_view isn't
        # loaded the docs URL + web_extract still works.
